...
def get_original_embedding_from_optimized(embedding=None, file=None, dim=DEFAULT_EMBEDDING_DIM, strategy=1):
...
def load(file, dim=DEFAULT_EMBEDDING_DIM, strategy=None):
    x = None
